...
public class FicheroAccesoAleatorio {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            FicheroAccesoAleatorio faa = new FicheroAccesoAleatorio("src/ficheroaccesoaleatorio/fic_acceso_aleat.dat", campos);
            ...
            // Mostramos el número de registros actuales
            System.out.println("Número de registros actuales: " + faa.getNumReg());

            // Intentamos insertar un registro en una posición muy superior
            reg.clear();
            reg.put("DNI", "99999999Z");
            reg.put("NOMBRE", "FUERA_DE_RANGO");
            reg.put("CP", "99999");
            faa.insertar(reg, 10); // Posición 10 (muy superior)

            System.out.println("Registro insertado en la posición 10");
            System.out.println("Nuevo número de registros: " + faa.getNumReg());
